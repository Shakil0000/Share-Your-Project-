...
const Admin = () => {
  ...
  return (
    <div>
      ...
      {
        loggedIUser.email === "shakiazzaman.s@gmail.com" ?
      <div>
      ...
      {/* from project data this code for showing project and copied from project section */}
      ...
      : <div><h1>Please logged in with Admin email</h1></div>
          }
